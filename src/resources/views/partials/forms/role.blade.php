<div class="form-group">
    <label>Name: *</label>
    <input type="text" class="form-control" name="name" value="@if(isset($role)){{$role->name}}@endif">
</div>
<div class="form-group">
    <label>Slug: *</label>
    <input type="text" class="form-control" name="slug" value="@if(isset($role)){{$role->slug}}@endif">
</div>
